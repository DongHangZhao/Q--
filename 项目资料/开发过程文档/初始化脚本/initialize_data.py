...
def initialize_users():
    ...
    # 内置用户数据
    users_data = [
        {'username': 'admin', 'email': 'admin@zhichi.com', 'password': 'admin123', 'is_admin': True},
        {'username': 'zhangsan', 'email': 'zhangsan@zhichi.com', 'password': 'password123'},
        {'username': 'lisi', 'email': 'lisi@zhichi.com', 'password': 'password123'},
        {'username': 'wangwu', 'email': 'wangwu@zhichi.com', 'password': 'password123'},
        {'username': 'zhaoliu', 'email': 'zhaoliu@zhichi.com', 'password': 'password123'},
        {'username': 'tianmi', 'email': 'tianmi@zhichi.com', 'password': 'password123'},
        {'username': 'xiaoming', 'email': 'xiaoming@zhichi.com', 'password': 'password123'},
...
def initialize_news():
    ...
    news_data = [
        ...
        },
        {
            ...
            'summary': '高等教育改革持续推进',
            'source': '人民日报',
            'timestamp': datetime.utcnow() - timedelta(hours=random.randint(3, 72))
        },
        {
            ...
            'summary': '医疗服务能力不断提升',
            'source': '健康报',
            'timestamp': datetime.utcnow() - timedelta(hours=random.randint(4, 96))
        },
        {
            ...
            'summary': '数字经济规模持续扩大',
            'source': '经济日报',
            'timestamp': datetime.utcnow() - timedelta(hours=random.randint(5, 120))
        },
        {
            ...
            'summary': '粮食产量再创新高',
            'source': '农民日报',
            'timestamp': datetime.utcnow() - timedelta(hours=random.randint(6, 144))
        },
        {
            ...
            'summary': '环境质量持续改善',
            'source': '中国环境报',
            'timestamp': datetime.utcnow() - timedelta(hours=random.randint(7, 168))
        },
        {
            ...
            'summary': '基础设施建设成效显著',
            'source': '中国交通报',
            'timestamp': datetime.utcnow() - timedelta(hours=random.randint(8, 192))
        }
    ]
...
def main():
    ...
    with app.app_context():
        ...
        print("  普通用户: zhangsan/lisi/wangwu/zhaoliu/tianmi/xiaoming/meimei (密码: password123)")
