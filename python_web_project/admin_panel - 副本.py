...
LastEditTime: 2026-04-11 23:36:37
LastEditors: ZDH
...
"""
# 一次性导入所有后台需要的模型
# admin_panel.py 顶部完整导入（直接复制全替换）
from models import User, Follows, UserStatus, Post, News, Video, NewsLike, PostLike, VideoLike, NewsOperationLog
import tablib
import csv
import io
...
from models import User, Follows, UserStatus, Post, News, Video, Comment, Message, Trending, ContentHistory, NewsLike, PostLike, VideoLike
from flask_admin.contrib.sqla import ModelView
from flask_admin import Admin
from flask import redirect, url_for, request, flash
from models import User, Follows, UserStatus, Post, News, Video, NewsLike, PostLike, VideoLike
from flask_login import current_user
# ===================== 关键修复：一次性导入所有模型 =====================
# 这一行解决所有 NameError 报错
# ======================================================================
...
def init_admin(app, db):
    ...
    # 系统模块
    admin.add_view(ModelView(Trending, db.session,
                   name='🔥 热度排行', category='⚙️ 系统'))
...
class UserAdminView(AdminModelView):
    ...
    column_list = ('id', 'username', 'email', 'is_admin', 'is_banned',
                   'can_post', 'can_video', 'can_comment', 'created_at')
